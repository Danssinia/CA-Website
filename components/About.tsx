                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="order-2 lg:order-1">
                        ...
                        <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-semibold leading-tight mb-6">
                            <span className="text-[var(--navy)]">Trusted Financial &</span>
                            <br />
                            <span className="text-[var(--orange)]">Compliance Advisors</span>
                        </h2>

                        {/* Paragraphs */}
                        <div className="space-y-5 text-[var(--black-90)] text-[15px] leading-relaxed">
                            <p>
                        ...
                        <p className="mt-10 text-[var(--orange)] text-lg italic font-medium">
                            GVJ & Associates, 2011
                        </p>
                    </div>
                    ...
                    <div className="order-1 lg:order-2 relative">
                        <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-[4/5] lg:aspect-[5/6]">
                            <Image
                                src="/law.jpg"
                                alt="Gajendra V Jain & Associates - Financial Advisors"
                                fill
                            ...
                            {/* Orange Badge */}
                            <div className="absolute bottom-6 left-6 bg-[var(--orange)] text-[var(--white)] px-5 py-3 rounded-lg shadow-lg">
                        ...
                        <div className="absolute -z-10 -right-8 -bottom-8 w-48 h-48 rounded-full bg-[var(--navy-5)] blur-2xl"></div>
                    </div>
                </div>
            </div>
        </section>
