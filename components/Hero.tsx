        ...
        <section className="relative min-h-[700px] overflow-hidden bg-[#1F4E79]">
            <div className="mx-auto grid min-h-[700px] max-w-[1920px] lg:grid-cols-2">
                ...
                <div className="relative z-20 flex flex-col justify-center px-8 py-16 sm:px-12 lg:px-16 xl:px-24">
                    ...
                    {/* Company Name */}
                    <p className="mb-6 font-serif text-2xl text-white sm:text-3xl">
                    ...
                    {/* Heading */}
                    <h1 className="max-w-2xl font-serif text-4xl leading-[1.1] text-white sm:text-5xl lg:text-6xl xl:text-[68px]">
                        Clarity in Numbers.
                        <br />
                        Confidence in{" "}
                        <span className="italic text-[#F28C28]">Growth.</span>
                    </h1>
                    ...
                    <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                        <button className="bg-[#F28C28] px-8 py-4 text-sm font-semibold tracking-[0.2em] text-white transition-opacity hover:opacity-90">
                            OUR SERVICES
                        </button>

                        <button className="border border-white/60 px-8 py-4 text-sm font-semibold tracking-[0.2em] text-white transition-colors hover:bg-white hover:text-[#1F4E79]">
                            GET IN TOUCH
                        </button>
                    </div>
                </div>
